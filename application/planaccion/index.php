	...
	<body class="hold-transition login-page">
        ...
        <div class="login-logo"><a href="https://telcelevaluaciones.softandgo.com/"><img style="width: 240px;" src="https://telcelevaluaciones.softandgo.com/img/logo_telcel_gray.png"></a></div>
            ...
            <p class="login-box-msg"><b>Usuario:</b> <?php echo $nombre?>  ||  <b>Nomina:</b> <?php echo $nomina?> </p>
            	...
            	<form name="form1" action="guardar.php" method="get">
	        			...
	        			<div class="col-sm-3" >
                         ...
                         <!-- <p align="center"><strong>Acciones</strong></p>-->
                           ...
                           <label class="col-sm-6 control-label" style="font-weight:normal">1) Actuar de manera eficiente frente a los obstáculos e imprevistos.</label>
                             ...
                             <div class="col-sm-2">
                            <input type="date" style=" color:#666666" name="res_1_1">
                             </div>
                          </div>
                           ...
                           <div class="col-sm-2">
                            <input type="date" style=" color:#666666" name="res_1_2">
                             </div>
                           </div>
                           ...
                           <div class="col-sm-2">
                            <input type="date" style=" color:#666666" name="res_1_3">
                             </div>		
        			     </div> 
	        			...
	        			<div class="col-sm-3" >
                         ...
                         <!-- <p align="center"><strong>Acciones</strong></p>-->
                           ...
                           <label class="col-sm-6 control-label" style="font-weight:normal">1) Comprometerme con mi equipo y otras áreas para lograr los resultados.</label>
                             ...
                             <div class="col-sm-2">
                            <input type="date" style=" color:#666666" name="res_2_1">
                             </div>
                          </div>
                           ...
                           <div class="col-sm-2">
                            <input type="date" style=" color:#666666" name="res_2_2">
                             </div>
                           </div>
                           ...
                           <div class="col-sm-2">
                            <input type="date" style=" color:#666666" name="res_2_3">
                             </div>		
        			     </div> 
	        			...
	        			<div class="col-sm-3" >
                         ...
                         <!-- <p align="center"><strong>Acciones</strong></p>-->
                           ...
                           <label class="col-sm-6 control-label" style="font-weight:normal">1) Diseñar y utilizar indicadores de gestión para medir y comparar los resultados obtenidos.</label>
                             ...
                             <div class="col-sm-2">
                            <input type="date" style=" color:#666666" name="res_3_1">
                             </div>
                          </div>
                           ...
                           <div class="col-sm-2">
                            <input type="date" style=" color:#666666" name="res_3_2">
                             </div>
                           </div>
                           ...
                           <div class="col-sm-2">
                            <input type="date" style=" color:#666666" name="res_3_3">
                             </div>		
        			     </div> 
                         <div class="col-sm-4">
                          <label class="col-sm-1 control-label" style="text-align:center"></label>
                         ...
                         <div class="col-sm-8">
                           ...
                           <div class="col-sm-2">
                            <input type="date" style=" color:#666666" name="res_3_4">
                             </div>		
        			     </div> 
	        			...
	        			<div class="col-sm-3" >
                         ...
                         <!-- <p align="center"><strong>Acciones</strong></p>-->
                           ...
                           <label class="col-sm-6 control-label" style="font-weight:normal">1) Promover el mejoramiento de la calidad.</label>
                             ...
                             <div class="col-sm-2">
                            <input type="date" style=" color:#666666" name="res_4_1">
                             </div>
                          </div>
                           ...
                           <div class="col-sm-2">
                            <input type="date" style=" color:#666666" name="res_4_2">
                             </div>
                           </div>
                           ...
                           <div class="col-sm-2">
                            <input type="date" style=" color:#666666" name="res_4_3">
                             </div>		
        			     </div> 
...
<!-- Fin fila-->  
      <!-- enviar  -->
              ...
              <div class="col-sm-4">
                            <input type="email" required placeholder="*Ingresa mail de tu jefe" style=" color:#666666" size="50"  name="mail">
                </div>	
