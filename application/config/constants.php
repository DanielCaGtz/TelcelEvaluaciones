...
defined('CLAVE_AVENTURA')		OR define('CLAVE_AVENTURA', 'AD2474');
defined('CLAVE_RECONSTRUYE')	OR define('CLAVE_RECONSTRUYE', 'RECONS');
defined('v2_TEST')				OR define('v2_TEST','COMPETENCIA');
