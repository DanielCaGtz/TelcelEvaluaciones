          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                	<?php $data=$controller->get_data_from_query("SELECT ppal.*, (SELECT nombre FROM instructores WHERE id=ppal.idInstructor) AS nombre_instructor FROM usuarios AS ppal WHERE ppal.id NOT IN (SELECT idUsuario FROM usuarios_permisos) ORDER BY rand() LIMIT 5"); if($data!==FALSE){ foreach($data AS $e=>$key){ ?>
                	<tr>
                		<td><p contenteditable="true"><?php echo $key["nombre"]; ?></p></td>
                		<td><p contenteditable="true"><?php echo $key["numero"]; ?></p></td>
                		<td><p contenteditable="true"><?php echo $key["nombre_instructor"]; ?></p></td>
                		<td><p contenteditable="true">SER EQUILIBRIO</p></td>
                		<td><p contenteditable="true">AVENTURA MUNDIAL DEL EXPERIENCIAS DE SERVICIO</p></td>
                	</tr>
                	<?php }} ?>
                </tbody>
                <tfoot>
            ...
            <form action="" method="post" id="form_container" name="form_container" role="form" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputFile">Subir calificaciones</label>
