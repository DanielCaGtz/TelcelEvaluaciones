	<div class="content-wrapper">
		...
		<section class="content-header">
	  		<h1>Carga de archivos <small>usuarios</small></h1>
	  		<ol class="breadcrumb">
				...
				<div class="col-md-12">
					<div class="box box-primary">
						<div class="box-header with-border">
			  				<h3 class="box-title">Carga de usuarios</h3>
						</div>
						<form action="" method="post" id="form_container_users" name="form_container" role="form" enctype="multipart/form-data">
			  				<div class="box-body">
								<div class="form-group">
				  					<label for="exampleInputFile">Subir usuarios</label>
