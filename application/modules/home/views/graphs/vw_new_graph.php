	...
	<body>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				$.post(window.url.base_url+"home/ctrhome/get_graph_data",{},function(resp){
					...
					if(resp.success!==false){
						...
						if(resp.protocolo_success!==false){
							Highcharts.chart('container2', {
								chart: {type: resp.protocolo_type_main},
								title: {text: resp.protocolo_title},
								subtitle: {text: resp.protocolo_subtitle},
								xAxis: {categories: resp.protocolo_categories},
								yAxis: {title: {text: 'Escala'}},
								plotOptions: {line: {dataLabels: {enabled: true},enableMouseTracking: true}},
								series: resp.protocolo_data_main
							});
						}
					}else{
