...
<html>
	<head>
		...
		<style>
			...
			.quest_container_1{
				background: url(img/new/cuadro-menu-aventura-mundial-op30.jpg);
				background-size: cover;
				color:black;
				font-weight: bold;
			}
			.quest_container_2{
				background: url(img/new/cuadro-menu-poder-op30.jpg);
				background-size: cover;
				color:black;
				font-weight: bold;
			}
	...
	<body class="hold-transition login-page">
		...
		<div class="login-box" id="main_header_box">
			...
			<?php }
			if($permisos!==FALSE){
				if(intval($permisos[0]["idDespacho"])>0) $w=" AND id=(SELECT idCurso FROM despachos WHERE id='".$permisos[0]["idDespacho"]."')";
