		...
		<div class="container">
			<div class="fs-form-wrap" id="fs-form-wrap">
				<div class="fs-title">
					...
					<h4>Contesta con sinceridad las alternativas que se presentan a continuación. 1: Nunca; 2: Casi nunca; 3: Algunas veces; 4: Casi siempre; 5: Siempre.</h4>
				...
				<form id="myform" class="fs-form fs-form-full" data-user="<?php echo $user; ?>" data-id="<?php echo $id_cuestionario; ?>" autocomplete="off">
					...
					<h3 class="aciertos">RANGO: <?php 
						if($aciertos <= 24) echo "12 - 24 NIVEL NULO: Tienes una oportunidad de mejora urgente.";
						elseif($aciertos>=25 && $aciertos <= 37) echo "25 - 37 NIVEL BAJO: Tienes una oportunidad de mejora importante.";
						elseif($aciertos>=38 && $aciertos <= 50) echo "38 - 50 NIVEL MEDIO: Tienes áreas de mejora.";
						elseif($aciertos>=51) echo "51 - 60 NIVEL ALTO: Brindaste un servicio de excelencia.";
					?></h3>
					...
					<ol class="fs-fields">
						...
						<li data-input-trigger>
							...
							<select data-id="<?php echo $key["id"]; ?>" class="cs-select cs-skin-boxes fs-anim-lower preguntas_select">
								...
								$letters=array(0=>"A) 1",1=>"B) 2",2=>"C) 3",3=>"D) 4", 4=>"E) 5"); for($jj=0; $jj<5; $jj++){ ?>
